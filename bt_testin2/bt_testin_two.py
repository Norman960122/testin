...
while run:
    ...
    run, save_flag, save_flag_short, left_sig_text, right_sig_text, horn_text = car_control(pygame.event.get(), ser, run, save_flag, save_flag_short, left_sig_text, right_sig_text, horn_text)#車子控制涵式
