...
model = load_model('model93.h5')#----------------------------------------------------------------讀取模型
...
#///////////////////////////////////////////////////////////////////
            ...
            sample = divide(float_array_2d)
            sample = sample.reshape(1, 10, 4, 1)
            preds = model.predict_classes(sample)#-----------------------------------判斷圖片(cnn)
