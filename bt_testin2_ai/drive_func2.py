...
import pygame
import numpy as np
def car_control(keyboard_event, ser, run, save_flag, save_flag_short, left_sig_text, right_sig_text, horn_text):
...
#---------------------------------------------------------------------------------------------------方向燈都是按下來改變狀態
            ...
            if event.key==pygame.K_LSHIFT:
                ser.write(b'xx\n')
    return run, save_flag, save_flag_short, left_sig_text, right_sig_text, horn_text
